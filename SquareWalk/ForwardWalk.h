...
#define FL_V_UP		BR_V_UP
#define FL_V_DN		BR_V_DN

#define BL_V_UP		FR_V_UP
#define BL_V_DN		FR_V_DN

//starting pose
PROGMEM prog_uint16_t START[]=		{8, BR_V_DN, FR_V_DN, FR_H_MID, BL_H_MID, BL_V_DN, FL_V_DN, BR_H_MID, FL_H_MID};
