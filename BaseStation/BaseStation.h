/**
  ...
  *
  * This header file contains the communication packet structure, enumerations
  * for packet components, and enumerations for different modes of operation
  * for the program.
  */
...
/**
  ...
  *
  * Packet bounds should always be set to 0xFF. Packet type should be set to a
  * PKT_Type. Values must be specified for every type except HELLO, GDBY,
  * STDBY, and RDY.
  */
typedef struct packet_struct{
    byte front_bnd;
    byte type;              /**< Type of packet */
    byte value;             /**< Relevant value for type of packet */
    byte end_bnd;
...
/**
  ...
  *
  * These are the different types of packets available for communication with
  * the robot. PKT_HELLO, PKT_GDBY, PKT_STDBY, and PKT_RDY are used to regulate
  * communication and do not need corresponding values.
  */
enum PKT_value{
...
/**
  ...
  *
  * This function will print and/or write to a log file error and warning
  * messages, depending on what the print mode variable is set to.
  */
void printmsg( void );
...
/**
  ...
  *
  * This function properly closes all subsystems and communication channels
  * before terminating the BaseStation program.
  */
void quit_base( void );
